...
class VerbsControllerTest < ActionController::TestCase
  ...
  test "should create verb" do
    assert_difference('Verb.count') do
      post :create, verb: { group: @verb.group, infinitive: @verb.infinitive, translation: @verb.translation }
    end
  ...
  test "should update verb" do
    patch :update, id: @verb, verb: { group: @verb.group, infinitive: @verb.infinitive, translation: @verb.translation }
    assert_redirected_to verb_path(assigns(:verb))
  end
